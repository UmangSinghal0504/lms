...
useEffect(() => {
  ...
  return (
    ...
    justify-between md:p-8 md:pb-0 pt-8 pb-0'>
      <form onSubmit={handleSubmit}  className='flex flex-col gap-4 max-w-md w-full text-gray-500'> 
        <div className='flex flex-col gap-1'>
          ...
          <div className='flex items-center justify-between flex-wrap'>
            ...
            type='number' placeholder='0' className='outline-none md:py-2.5 py-2 w-28 px-3 rounded border border-gray-500' requried />
            </div>
            ...
            <div className='flex md:flex-row flex-col items-center gap-3'>
              ...
              <label htmlFor='thumbnailImage' className='flex items-center gap-3'>
                ...
                <input type='file' id='thumbnailImage' onChange={e => setImage(e.targetfiles[0])} accept='image/*' hidden />
            ...
            <div key={chapterIndex} className='bg-white border rounded-lg mb-4'>
              <div className='flex justify-between items-center p-4 border-b'>
                <div className='flex items-center'>
                  <img onClick={() => handleChapter('toogle', chapter.chapterId)} src={assets.dropdown_icon} width={14} alt='' className=
