...
const CourseDetails = () => {
  ...
  useEffect(() => {
    fetchCourseData();
  }, [allCourses]); // Re-run when allCourses changes
  ...
  // Show a loading message or fallback UI while courseData is null
  // Show a loading icon while courseData is null
  if (!courseData) {
    return (
    ...
    <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
      ...
      <div className="max-w-xl z-10 text-gray-500">
        ...
        {/* Review and Rating */ }
              ...
              <p className="text-sm">{courseData.enrolledStudents.length} {courseData.enrolledStudents.length > 1 ? 'students' : 'student'}</p>
          </div>
            ...
            <div className="pt-5">
              {courseData.courseContent.map((chapter, index)=> (
                <div key={index} className="border border-gray-300 bg-white mb-2 rounded">
                  ...
                  cursor-pointer select-none" onClick={() => toogleSection(index)}>
      ...
      md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
        ...
        <div className="p-5">
          ...
          <p className="text-gray-800 md:text-4xl text-2xl font-semibold">${courseData.currency}{(courseData.coursePrice - courseData.discount * 
  courseData.coursePrice / 100).toFixed(2)}</p>
  <p className="md:text-lg text-gray-500 line-through">${courseData.currency}{courseData.coursePrice}</p>
